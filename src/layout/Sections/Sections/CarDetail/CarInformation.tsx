...
import tyreIcon from "../../assets/carDetail/tyre 2.png"
const CarInformation = ({ info, feature,carTitle,city,assembly,bodyType,color,engineCapacity, updatedAt}: ICar) => {
      ...
      <Grid className={Info} item xs={12}>
              ...
              >
                ...
                <Grid  item lg={3}>
                  ...
                  <Typography variant="subtitle1">{updatedAt && ConvertDate(updatedAt)}</Typography>
                </Grid>
              </Grid>
      </Grid>
