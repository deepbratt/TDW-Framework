...
const CarInformation = ({ info, feature,carTitle,city,assembly,bodyType,color,engineCapacity,date}: ICar) => {
      ...
      <Grid className={Info} item xs={12}>
              ...
              >
                ...
                <Grid  item lg={3}>
                  ...
                  <Typography variant="subtitle1">{ConvertDate(date)}</Typography>
                </Grid>
              </Grid>
      </Grid>
